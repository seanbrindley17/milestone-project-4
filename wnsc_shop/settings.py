"""
Django settings for wnsc_shop project.
...
if "USE_AWS" in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = "milestone-project-4-sb"
    ...
    # Overwrite static and media urls in production
...
if "DEVELOPMENT" in os.environ:
    ...
    DEFAULT_FROM_EMAIL = "wscshop@email.com"
else:
